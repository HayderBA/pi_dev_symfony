 ...
 */
final class Version20260421213536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quiz_reponse (id INT AUTO_INCREMENT NOT NULL, score INT NOT NULL, created_at DATETIME NOT NULL, user_id INT NOT NULL, INDEX IDX_4DEC7367A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE quiz_reponse ADD CONSTRAINT FK_4DEC7367A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
