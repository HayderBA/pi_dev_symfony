 ...
 */
final class Version20260410135433 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, auteur VARCHAR(100) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, contenu LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, datecreation DATETIME NOT NULL, likes INT NOT NULL, forumpost_id INT NOT NULL, INDEX IDX_5FB6DEC7AA15D77E (forumpost_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
