...
#[ORM\Entity]
#[ORM\Table(name: 'sleep_tracking', indexes: [
    new ORM\Index(name: 'fk_sleep_utilisateur', columns: ['user_id']),
    new ORM\Index(name: 'idx_sleep_user_id', columns: ['user_id']),
    new ORM\Index(name: 'idx_sleep_date_sommeil', columns: ['date_sommeil']),
])]
class SleepTracking
{
    #[ORM\Id]
