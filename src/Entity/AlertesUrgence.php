...
use App\Repository\AlertesUrgenceRepository;

#[ORM\Entity(repositoryClass: AlertesUrgenceRepository::class)]
#[ORM\Table(name: 'alertes_urgence')]
class AlertesUrgence
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
